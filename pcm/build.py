...
# copy icon
shutil.copytree(resources_path, path.join('plugin', 'resources'), ignore=shutil.ignore_patterns('.DS_Store'))  # noqa
...
md['versions'][0].update({
    ...
    'download_url': 'https://github.com/BatNoize/Dial-Scale-FrontPanel-Footprint-Wizard/releases/download/{0}/Dial_Scale_FrontPanel_FootprintWizard_{0}.zip'.format(md['versions'][0]['version'])  # noqa
})
